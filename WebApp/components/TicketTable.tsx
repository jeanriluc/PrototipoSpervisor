        ...
        <table className="w-full border-collapse min-w-[800px]">
          <thead>
            <tr className="bg-white border-b border-slate-50">
              ...
              <th className="px-6 py-5 text-left text-[11px] font-black uppercase tracking-widest text-slate-600 whitespace-nowrap">ID</th>
              <th
                className="px-6 py-5 text-left text-[11px] font-black uppercase tracking-widest text-slate-600 cursor-pointer hover:text-slate-900 group whitespace-nowrap"
              ...
              <th className="px-6 py-5 text-left text-[11px] font-black uppercase tracking-widest text-slate-600">Ticket Subject</th>
              <th
                className="px-6 py-5 text-left text-[11px] font-black uppercase tracking-widest text-slate-600 cursor-pointer hover:text-slate-900 group whitespace-nowrap"
              ...
              <th className="px-6 py-5 text-left text-[11px] font-black uppercase tracking-widest text-slate-600">Assignee</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-5">
                      {isClosed ? (
                        ...
                        <div
                          className={`group/sla relative flex items-center gap-2 whitespace-nowrap px-3 py-2 rounded-xl border transition-all ${time.isExpired ? 'bg-rose-100/50 border-rose-200 animate-pulse [animation-duration:2s]' : 'border-transparent'}`}
                        >
                          {time.isExpired ? (
                            <>
                              ...
                              <div
                                role="tooltip"
                                aria-label="Deadline Passed - Immediate action needed"
                                className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-3 bg-slate-900 text-white text-[10px] font-black uppercase tracking-widest leading-relaxed rounded-2xl opacity-0 group-hover/sla:opacity-100 group-focus-within/sla:opacity-100 pointer-events-none transition-opacity shadow-xl z-10"
                              >
