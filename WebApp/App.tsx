    ...
    <div className="flex h-screen w-screen bg-[#FDFCF9] overflow-hidden text-slate-800">
              ...
              <div className="flex flex-col gap-4 flex-1 min-h-0">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-4 shrink-0">
                  <div>
                    ...
                    <p className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] mt-2">Active Support Stream</p>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="relative group/agent">
                      ...
                      <input
                        ...
                        className="bg-white border border-slate-100 rounded-2xl py-2 pl-9 pr-8 text-xs font-black text-slate-600 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 outline-none shadow-sm transition-all w-44 placeholder:text-slate-500 placeholder:font-bold"
                      />
                      {agentSearchName && (
                        <button
                    ...
                    <div className="flex bg-white p-1 rounded-2xl border border-slate-100 shadow-sm mr-2">
                      {(['All', 'Open', 'Pending', 'Closed'] as const).map((status) => (
                        <button
                          ...
                          className={`px-4 py-1.5 rounded-xl text-[10px] font-black transition-all duration-200 ${statusFilter === status
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-4 py-2 rounded-2xl text-[10px] font-black transition-all duration-200 border focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 outline-none ${filterUnassigned
      ...
      {activeTab !== 'inbox' && selectedTicket && (
        <div className="fixed inset-0 z-[100] flex items-center justify-end p-10 bg-slate-900/10 backdrop-blur-sm animate-in fade-in duration-300">
          ...
          />
          <div className="relative w-full max-w-xl h-full animate-in slide-in-from-right duration-300 shadow-2xl rounded-[3rem] overflow-hidden bg-white border border-slate-100">
            <Customer360
              ticket={selectedTicket}
              allTickets={tickets}
              agents={agents}
